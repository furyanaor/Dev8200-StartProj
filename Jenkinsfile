      ...
      parallel {
        ...
        stage('Build') {
          steps {
            ...
            sh 'if sudo docker ps | grep dev8200; then sudo docker-compose -f /var/lib/jenkins/workspace/Dev8200-StarterProj-Pip/Dev8200-StartProj/docker-compose.yml down; fi'
